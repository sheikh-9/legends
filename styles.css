...
.tournament-selection-card:hover {
...
.tournament-selection-card:hover .selection-arrow {
...
/* Old tournament card styles - keeping for compatibility */
.tournament-grid {
    display: grid;
...
.details-tab-btn:hover:not(.active) {
